...
export default class TableScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tableData: [
        [elementButton('mg_per_dl'), 'a', 'b', 'c', 'd'],
        [elementButton('mmol_per_liter'), '1', '2', '3', '4'],
        [elementButton('mg_per_dl_corrected_with_custom_formula'), 'a', 'b', 'c', 'd']
      ]
    }
  }
      ...
      <View style={styles.container}>
        <Table style={{flexDirection: 'row'}} borderStyle={{borderWidth: 1}}>
          ...
          <TableWrapper style={{flex:1}}>
            <Cols data={state.tableData} heightArr={[80, 30, 30, 30, 30]} textStyle={styles.text}/>
          </TableWrapper>
        </Table>
      </View>
    )
...
const styles = StyleSheet.create({
  ...
  singleHead: { width: 80, height: 80, backgroundColor: '#c8e1ff' },
