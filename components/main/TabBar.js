...
const TabBar = (props) =>{
    return (
        <View style={{height:'20%', width:'100%' , marginBottom:10  ,borderLeftColor: 'transparent', borderBottomLeftRadius :20, borderBottomEndRadius: 20,borderTopLeftRadius:50,elevation:2}} >
